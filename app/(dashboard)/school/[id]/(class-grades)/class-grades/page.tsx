...
export const metadata: Metadata = {
  title: "Class Grades",
  description: "Class Grades Page",
}

export default async function ClassGradesPage({ params }: { params: { id: string } }) {
  const student = await getStudent(params.id as string);
  if (!student) {
    return (
      <p>No student found

        Class Grades Page for School
      </p>
    )
  }
  ...
  <BreadcrumbList>
    ...
    <BreadcrumbSeparator />
    <BreadcrumbItem>
      <BreadcrumbPage>Class Grades</BreadcrumbPage>
    </BreadcrumbItem>
  </BreadcrumbList>
</Breadcrumb>
