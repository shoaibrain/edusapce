...
export function StudentAdmissionForm({
  ...
  async function onSubmit(data: formData) {
    ...
    //TODO: after successful student registration, redirect to student profile page.
      router.refresh();
    } catch (error) {
  ...
  return (
    <Card className="border border-blue-300">
        <CardHeader className="border-b border-blue-300 p-4">
            ...
            <CardDescription>Fill in the below information to get started with student admission.</CardDescription>
        </CardHeader>
      <CardContent>
        <Form {...form}>
